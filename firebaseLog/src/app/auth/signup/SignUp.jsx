    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-500 via-gray-700 to-gray-900 px-4">
      <div
       ...
       ${
        ...
        ease-out`}
      >
        <h2 className="text-3xl font-bold text-center mb-4">Hello!</h2>
        ...
        <button
          ...
          className=" mt-6 w-full cursor-pointer flex items-center justify-center bg-gray-700 border border-gray-600 py-2
